...
repstatus (repStatusID,repStatusType,repStatusDateCreated,repStatusFKreports,repStatusRemark,repUserID)

 VALUES (?,?,?,?,?,?)");

// Bind the parameters to the placeholders
$stmt_insertRepStatus->bind_param("issisi", $repStatusID, $repStatusType, $datetime, $repID,$repStatusRemark, $repUserID);
